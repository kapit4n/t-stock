...
class RequestRowCustomerController @Inject()(repo: RequestRowCustomerRepository, repoRequestRow: RequestRowRepository,
  ...
  def index = LanguageAction.async { implicit request =>
    repo.list().map { res =>
      Ok(views.html.order.requestRowCustomer_index(new MyDeadboltHandler, res))
    }
  }
  ...
  def addGet(requestRowId: Long) = LanguageAction { implicit request =>
    ...
    Ok(views.html.order.requestRowCustomer_add(new MyDeadboltHandler, parentId, searchCustomerForm, newForm.bind(anyData), requestRows,
  ...
  def addDriverGet(requestRowId: Long) = LanguageAction { implicit request =>
    ...
    drivers = getDrivers()
    measures = getMeasureMap()
    Ok(views.html.order.requestRowDriver_add(new MyDeadboltHandler, parentId, newDriverForm, requestRows,
  ...
  def add = LanguageAction.async { implicit request =>
    newForm.bindFromRequest.fold(
      errorForm => {
        println(errorForm)
        Future.successful(Ok(views.html.order.requestRowCustomer_add(new MyDeadboltHandler, parentId, searchCustomerForm, errorForm,
  ...
  def addDriver = LanguageAction.async { implicit request =>
    newDriverForm.bindFromRequest.fold(
      errorForm => {
        println(errorForm)
        Future.successful(Ok(views.html.order.requestRowDriver_add(new MyDeadboltHandler, parentId, errorForm,
  ...
  def show(id: Long) = LanguageAction.async { implicit request =>
    repo.getById(id).map { res =>
      Ok(views.html.order.requestRowCustomer_show(new MyDeadboltHandler, res(0)))
    }
  }
  ...
  def getUpdate(id: Long) = LanguageAction.async { implicit request =>
    repo.getById(id).map {
      case (res) =>
        ...
        Ok(views.html.order.requestRowCustomer_update(new MyDeadboltHandler, updatedRow,
  ...
  def getDriverUpdate(id: Long) = LanguageAction.async { implicit request =>
    repo.getById(id).map {
      case (res) =>
        ...
        Ok(views.html.order.requestRowDriver_update(new MyDeadboltHandler, updatedRow,
  ...
  def updatePost = LanguageAction.async { implicit request =>
    updateForm.bindFromRequest.fold(
      errorForm => {
        Future.successful(Ok(views.html.order.requestRowCustomer_update(new MyDeadboltHandler, updatedRow,
  ...
  def updateDriverPost = LanguageAction.async { implicit request =>
    updateDriverForm.bindFromRequest.fold(
      errorForm => {
        Future.successful(Ok(views.html.order.requestRowDriver_update(new MyDeadboltHandler, updatedRow,
  ...
  def searchCustomerPost = LanguageAction.async { implicit request =>
    searchCustomerForm.bindFromRequest.fold(
      errorForm => {
        Future.successful(Ok(views.html.order.requestRowCustomer_add(new MyDeadboltHandler, parentId, searchCustomerForm,
